...
def train_final_model(df):
    ...
    ohe = OneHotEncoder(cols=['시군구'], use_cat_names=True)
    ...
    return final_model, te, ohe, X_train_final.columns

# --- 1. 데이터 로드 및 전처리 ---
try:
    data_path = '서울_매매_합본.csv'
...
# --- 2. 최종 모델 훈련 실행 ---
final_model, te, ohe, columns = train_final_model(df_with_features)
