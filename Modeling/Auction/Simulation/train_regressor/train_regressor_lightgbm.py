# train_regressor_lightgbm.py
"""
낙찰된 경매 데이터를 사용하여 '낙찰가'를 예측하는 LightGBM 회귀 모델을 학습합니다.
"""
import os
import sys
import numpy as np
...
RANDOM_STATE = 42
MODEL_OUT = "../trained_model/auction_regressor_lgbm.joblib"
...
def main():
    ...
    print("\n[INFO] 회귀 모델 학습 시작...")
    model = train_lgbm_regressor(X_train, y_train, X_test, y_test)
